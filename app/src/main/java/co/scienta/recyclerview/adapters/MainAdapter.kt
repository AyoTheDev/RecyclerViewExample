...
class MainAdapter(private val listener: ItemListListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            TYPE_9 -> {
                val binding: Item9ViewBinding = Item9ViewBinding.inflate(inflater)
                TypeNineViewHolder(binding, listener)
            }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        return when (holder) {
            ...
            is TypeNineViewHolder -> holder.bind(items[position] as TypeNineItem, viewPool)
