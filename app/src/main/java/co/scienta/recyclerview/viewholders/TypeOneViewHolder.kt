...
import co.scienta.recyclerview.TypeOneItem
import co.scienta.recyclerview.R
import co.scienta.recyclerview.adapters.ItemListListener
import co.scienta.recyclerview.databinding.Item1ViewBinding

class TypeOneViewHolder(private val binding: Item1ViewBinding, private val listener: ItemListListener)
